package io.moonnight.leetcode.Backtracking;// Given an Android 3x3 key lock screen and two integers m and n, where 1 ≤ m ≤ n ≤ 9, count the total number of unlock patterns of the Android lock screen, which consist of minimum of m keys and maximum n keys.
...
public class BacktrackingAndroidUnlockPatterns {
