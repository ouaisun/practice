package io.moonnight.leetcode.Backtracking;// Write a function to generate the generalized abbreviations of a word.
...
public class BacktrackingGeneralizedAbbreviation {
