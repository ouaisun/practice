package io.moonnight.leetcode.BreadthFirstSearch;// You want to build a house on an empty land which reaches all buildings in the shortest amount of distance. You can only move up, down, left and right. You are given a 2D grid of values 0, 1 or 2, where:
...
public class BreadthFirstSearchShortestDistanceFromAllBuildings {
