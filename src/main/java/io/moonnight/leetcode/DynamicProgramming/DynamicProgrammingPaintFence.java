package io.moonnight.leetcode.DynamicProgramming;// There is a fence with n posts, each post can be painted with one of the k colors.
...
public class DynamicProgrammingPaintFence {
